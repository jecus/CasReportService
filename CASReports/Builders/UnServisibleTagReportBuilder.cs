...
{
	public class UnServisibleTagReportBuilder : AbstractReportBuilder
	{
		...
		public UnServisibleTagReportBuilder(Operator @operator, Component component)
		{
		...
		{
			var report = new UnServisibleTagReport();
