...
{
    public class ComponentTasksReportBuilder : AbstractReportBuilder
    {
        #region Fields
        ...
        private string _reportTitle = "COMPONENT RECORD";
        ...
        {
            var report = new DirectiveTaskReport();
        ...
        private void AddAdditionalDataToDataSet(DirectivesListDataSet destinationDateSet)
        {
            ...
            destinationDateSet.AdditionalDataTAble.AddAdditionalDataTAbleRow(_reportTitle, OperatorLogotype, _filterSelection, DateAsOf, firsttitle, discriptiontitle, secondtitle, reportFooter, reportFooterPrepared, reportFooterLink);
